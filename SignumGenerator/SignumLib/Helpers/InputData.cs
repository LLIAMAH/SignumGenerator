...
namespace SignumLib.Helpers
{
    public class InputBaseData
    {
        ...
        public InputBaseData(SignumTincture tinctureMain, SignumTincture tinctureSub, SignumTincture tinctureBg)
        {
    ...
    public class InputLayerData
    {
        ...
        public InputLayerData(SignumBasePattern pattern,
            SignumTincture tinctureMain, SignumTincture tinctureSub = null, SignumTincture tinctureBg = null,
